...
CREATE TABLE `request_asset` (
  ...
  `quantity_asset` varchar(50) NOT NULL,
...
(2, 'Mouse', 'Pending', '6', 403, '2024-01-17');
...
--
ALTER TABLE `request_asset`
  MODIFY `req_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `transaction_table`
  MODIFY `trans_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
